...
const WP = {
  ...
  borz: { n:'ПП «Борз»', r:150, rof:.7, acc:.3, di:5, dv:0, pen:1, supp:7, k:'small' },
  ...
  ags:  { n:'АГС-17 «Пламя»', r:1200, rof:1.4, acc:.32, di:13, dv:4, pen:8, supp:32, k:'mg', he:true, splash:8, bd:6, gl:true }
};
...
const AIR = { name:'Штурмовка Су-25', cost:60, cd:150, speed:190, hp:60, bombs:6, r:30, dmg:70, pen:40, bdmg:150, kill:60 };
...
function decodeSnap(s){
  return { phase:s.ph, phaseT:s.pt, t:s.t, sides:s.S, objs:s.o, bh:s.bh, res:s.res, marks:s.a, civDead:s.cd, civEvac:s.ce, bldDown:s.bdn,
    ...
    units:s.u.map(a => ({ id:a[0], type:TK[a[1]], side:a[2] ? 'chr' : 'fed', x:a[3], y:a[4], h:a[5]/100, hp:a[6], supp:a[7],
      ...
      dest:a[9] >= 0 ? { x:a[9], y:a[10] } : null, ammo:a[11], ta:a[12]/100, carrier:a[13], smk:a[14], immob:!!(a[15]&1), working:(a[15]&2) ? ((a[15]&8) ? 'mine' : 'barr') : null, boarding:!!(a[15]&4), afire:a[16] >= 0 ? { x:a[16], y:a[17] } : null, nocomm:!!(a[18]&1), under:!!(a[18]&2), pend:a[19] || 0, q:a[20] || null, ambush:!!(a[21]&1), inFire:!!(a[21]&2) })), fires:s.fr || [], traps:s.tp || [], air:s.ar || [] };
}

if (typeof module !== 'undefined') module.exports = { AIR, trapOk, engAvail, cellarPath, cellarReach, hasComm, UT, SCEN, AB, AB2, ENG, T, CELL, TK, spawnUnit, infilOk, engOk, makeGame, step, applyCommand, aiStep, encodeSnap, decodeSnap, findPath, buildMap, los };
